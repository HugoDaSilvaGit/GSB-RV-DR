...
INSERT INTO `Famille` VALUES ('AA','Antalgiques en association'),
                             ...
                             ('ALO','Antibiotique local (ORL)'),('ANS','Antidépresseur IMAO non sélectif'),
                             ('AO','Antibiotique ophtalmique'),('AP','Antipsychotique normothymique'),
...
INSERT INTO `Laboratoire` VALUES ('BC','Bichat','Suzanne Terminus'),
...
INSERT INTO `Offrir` VALUES ('a131',1,'EVILR7',2),
                            ('a131',1,'PHYSOI8',5);
...
INSERT INTO `Praticien` VALUES (1,'Notini','Alain','114 r Authie','85000','LA ROCHE SUR YON',290.03,'MH'),
...
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `Motif` (
   `mo_nummotif` int(5) NOT NULL DEFAULT '0',
   `mo_libellemotif` varchar(30) NOT NULL DEFAULT '',
   PRIMARY KEY (`mo_nummotif`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `Motif` VALUES (1,'Informations'),
                           (2,'Visite Ponctuelle'),
                           (3,'Visite programmé'),
                           (4,'Nouveautés'),
                           (5,'Actualisations');
...
CREATE TABLE `RapportVisite` (
  ...
  `mo_nummotif` int(5) DEFAULT NULL,
  `rap_coefconfiance` int(2) DEFAULT '0',
  ...
  CONSTRAINT `FK_RAPPORT_VISITE_MOTIF` FOREIGN KEY (`mo_nummotif`) REFERENCES `Motif` (`mo_nummotif`),
...
INSERT INTO `RapportVisite` VALUES ('a131',147,'2021-12-05','xxxxxxx',75,1,8),
                                   ('a54',146,'2021-12-03','xxxxxxx',46,2,10),
                                   ('b16',145,'2021-11-28','xxxxxxx',46,3,9),
                                   ('l23',144,'2021-11-26','xxxxxxx',11,3,2),
                                   ('l56',143,'2021-11-23','xxxxxxx',65,3,2),
                                   ('s10',142,'2021-11-18','xxxxxxx',3,1,2),
                                   ('t43',141,'2021-11-18','xxxxxxx',32,1,3),
                                   ('r58',140,'2021-11-13','xxxxxxx',24,5,1),
                                   ('p7',139,'2021-10-09','xxxxxxx',18,5,5),
                                   ('e22',138,'2021-10-05','xxxxxxx',18,5,5),
                                   ('a24',137,'2021-10-04','xxxxxxx',19,5,7),
                                   ('d13',136,'2021-10-03','xxxxxxx',27,4,8),
                                   ('d51',135,'2021-10-03','xxxxxxx',40,3,7),
                                   ('n59',134,'2021-10-02','xxxxxxx',76,4,8),
                                   ('N58',133,'2021-09-26','xxxxxxx',50,3,8),
                                   ('o26',132,'2021-09-25','xxxxxxx',49,4,6),
                                   ('r24',131,'2021-09-22','xxxxxxx',45,3,6),
                                   ('s10',130,'2021-09-21','xxxxxxx',34,2,2),
                                   ('l23',129,'2021-09-15','xxxxxxx',78,2,10),
                                   ('e5',128,'2021-09-10','xxxxxxx',37,2,10),
                                   ('a52',127,'2021-09-06','xxxxxxx',14,2,10),
                                   ('f39',126,'2021-08-30','xxxxxxx',9,2,10),
                                   ('f4',125,'2021-08-29','xxxxxxx',12,1,7),
                                   ('c3',124,'2021-06-03','xxxxxxx',57,3,7),
                                   ('j8',123,'2021-06-03','xxxxxxx',52,3,8),
                                   ('k4',122,'2021-06-02','xxxxxxx',63,1,4),
                                   ('d51',121,'2021-06-02','xxxxxxx',3,1,4);
...
INSERT INTO `Region` VALUES ('AL','E','Alsace Lorraine'),
                            ('AQ','S','Aquitaine'),
                            ('AU','P','Auvergne'),
                            ('BG','O','Bretagne'),
...
INSERT INTO `Specialite` VALUES ('ACP','anatomie et cytologie pathologiques'),
...
INSERT INTO `Travailler` VALUES ('a131','2014-01-05','BN','Visiteur'),
...
INSERT INTO `TypePraticien` VALUES ('MH','Médecin Hospitalier','Hopital ou clinique'),
...
INSERT INTO `Visiteur` VALUES ('a131','Villechalane','Louis','8 cours Lafontaine','29000','BREST','2012-11-08',NULL,'SW','azerty'),
